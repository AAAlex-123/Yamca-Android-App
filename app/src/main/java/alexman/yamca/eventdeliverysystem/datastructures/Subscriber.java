...
/**
 * An interface denoting any class that needs to be notified about the arrival of a part of or a
 * whole {@link Post}.
 *
...
public interface Subscriber {
	...
	/**
	 * Notifies the object that a part of a post has arrived, concerning a certain Topic.
	 *
